    ...
    <div className="mb-8">
      ...
      >
        <div className="mx-auto border-solid lg:pl-8 max-w-7xl">
          <div>
            <h2 className="m-0 text-2xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-t from-blue-500 to-purple-500 sm:text-4xl md:text-3xl">
              Our Features
            </h2>
            <p className="mt-2 text-xl text-center border-0 border-gray-200">
              Web development and maintenance.
            </p>
            <p className="text-xl text-blue-700 my-4 text-center">
              ...
              <div className="grid gap-4 mt-8 border-0 border-gray-200 sm:mt-10 sm:gap-6 lg:mt-12 lg:gap-8">
                <div className="flex items-start text-gray-900 border-solid ">
                  ...
                  <div className="flex-1 ml-6 border-0 border-gray-200">
                    <h3 className="m-0 text-lg font-semibold text-black border-solid sm:text-xl md:text-2xl">
                      Custom web design
                    </h3>
